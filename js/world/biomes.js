...
export const BIOMES = [
  ...
  },
  {
    ...
    fog: '#e6dcd0', heat: 1.2,
    plants: ['saltgrass', 'dustmoss', 'pipereed', 'saltpetal', 'sandwheat'],
  ...
  },
  {
    ...
    fog: '#ded3b8', heat: 0.9,
    plants: ['ribbonkelp', 'dustmoss', 'emberberry', 'sunpod'],
  ...
  },
  {
    ...
    fog: '#e6bc84', heat: 1.0,
    plants: ['dustmoss', 'saltgrass', 'emberberry', 'sunspindle', 'thornmelon', 'sandwheat', 'sunpod'],
  ...
  },
  {
    ...
    fog: '#d3e6ef', heat: 1.4,
    plants: ['glasslily', 'dustmoss', 'bluefern', 'saltpetal'],
  ...
  },
  {
    ...
    plants: ['worldvine', 'dustmoss', 'emberberry', 'ashroot', 'stonefig'],
  ...
  },
  {
    ...
    fog: '#8e7d92', heat: 0.7,
    plants: ['bluefern', 'cloudcap', 'ironwood', 'ashroot', 'nightcup'],
  ...
  },
  {
    ...
    fog: '#3f6d80', heat: 0.5,
    plants: ['dustmoss', 'heartbloom', 'ghostpalm', 'nightcup', 'stonefig'],
