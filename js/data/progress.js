...
export const GENES = [
  ...
  { id: 'thornhide', name: 'Thorn Hide', from: 'Horned Pebbler', desc: 'Scales grown into spines that comb dew into the mouth.', icon: 'shield', combat: { cd: 14, desc: 'Spines out. Whatever hits you next takes it back.' } },
  { id: 'dusk', name: 'Dusk Sight', from: 'Sun Moth', desc: 'Antennae that read a single molecule at a kilometre.' },
  { id: 'lumen', name: 'Lumen Organ', from: 'Lantern Beetle', desc: 'Cold light, made on purpose.', icon: 'bolt', combat: { cd: 10, desc: 'Cold light, all at once. Anything looking at you flinches.' } },
  { id: 'bulwark', name: 'Bulwark', from: 'Ridgeback Grazer', desc: 'Bone plate that grew because it had to.', icon: 'shield', combat: { cd: 16, desc: 'Plate down. You take half for a while.' } },
  ...
  { id: 'signal', name: 'Signal Skin', from: 'Ribbon Agama', desc: 'Colour under nervous control, changing in seconds.', icon: 'burrow', combat: { cd: 11, desc: 'The shell goes the colour of the sand and the animal loses you.' } },
  { id: 'apex', name: 'Apex Nerve', from: 'Salt Monitor', desc: 'A reptile that caches food and comes back for it.', icon: 'saw', combat: { cd: 12, desc: 'It knows where the joint is. Double damage on the next core hit.' } },
  ...
  { id: 'strike', name: 'Strike Reflex', from: 'Mirror Mantis', desc: 'Fifty milliseconds from still to closed.', icon: 'claw', combat: { cd: 7, desc: 'Fifty milliseconds from still to closed. The next strike lands whatever the gauge says.' } },
...
export const BUILDINGS = [
  ...
  { id: 'bench', name: 'Work Bench', kind: 'crate', w: 16, h: 10, cost: 70, nut: 8,
    effect: {}, desc: 'A slab and a vice, bolted to your back. Everything past a '
      + 'bar of metal is made here.' },
