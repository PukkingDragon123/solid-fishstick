...
export const RECIPES = [
  ...
  { id: 'spool', at: 'hand', out: ['spool', 1], need: [['shellchip', 3]], secs: 1.0 },
  ...
  { id: 'pickcopper', at: 'bench', out: ['pickcopper', 1],
    need: [['copperbar', 2], ['spool', 1]], secs: 2.6 },
  { id: 'pickiron', at: 'bench', out: ['pickiron', 1],
    need: [['ironbar', 3], ['spool', 1], ['gearset', 1]], secs: 3.4 },
  { id: 'sprayer', at: 'bench', out: ['sprayer', 1],
    need: [['pipe', 1], ['pane', 1], ['spool', 2]], secs: 3.0 },
];
